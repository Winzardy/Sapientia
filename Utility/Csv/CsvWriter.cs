...
namespace NReco.Csv
{
	...
	{
		public static void WriteField(this CsvWriter writer, bool value)
		{
			writer.WriteField(value.ToString());
		}

		public static void WriteField(this CsvWriter writer, int value)
		{
			writer.WriteField(value.ToString(CultureInfo.InvariantCulture));
		}

		public static void WriteField(this CsvWriter writer, long value)
		{
			writer.WriteField(value.ToString(CultureInfo.InvariantCulture));
		}

		public static void WriteField(this CsvWriter writer, float value)
		{
			writer.WriteField(value.ToString(CultureInfo.InvariantCulture));
		}

		public static void WriteField(this CsvWriter writer, double value)
		{
			writer.WriteField(value.ToString(CultureInfo.InvariantCulture));
		}
	}

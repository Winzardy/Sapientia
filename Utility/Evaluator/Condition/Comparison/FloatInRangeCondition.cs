...
{
	[Serializable]
	public abstract class FloatInRangeCondition<TContext> : Condition<TContext>
	{
#if CLIENT
...
#endif
		public EvaluatedValue<TContext, float> min = 0;
...
#endif
		[SerializeReference]
		public Evaluator<TContext, float> value;
		...
		[HorizontalGroup(GROUP + "/group"), HideLabel]
#endif
		public EvaluatedValue<TContext, float> max = 1;

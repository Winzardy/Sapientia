...
namespace Sapientia.Collections.Fixed
{
	...
	public static unsafe class UTF8Ext
	{
			...
			int srcLength)
		{
			...
			MemoryExt.MemCopy(src, dest + destLength, srcLength);
			...
			int utf16LengthInCharsB)
		{
			...
			{
				var utf16ErrorA =
					Unicode.Utf16ToUcs(out var utf16RuneA, utf16BufferA, ref charIndexA, utf16LengthInCharsA);
				var utf16ErrorB =
					Unicode.Utf16ToUcs(out var utf16RuneB, utf16BufferB, ref charIndexB, utf16LengthInCharsB);

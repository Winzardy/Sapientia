...
namespace Sapientia.TypeIndexer
{
	...
	{
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void ProxyDispose(this ref ProxyPtr<IInterfaceProxyTypeProxy> __proxyPtr, SafePtr<Sapientia.MemoryAllocator.Allocator> allocator)
		{
			__proxyPtr.proxy.ProxyDispose(__proxyPtr.GetPtr().ptr, allocator);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void ProxyDispose(this ref ProxyPtr<IInterfaceProxyTypeProxy> __proxyPtr, SafePtr<Sapientia.MemoryAllocator.Allocator> __allocator, SafePtr<Sapientia.MemoryAllocator.Allocator> allocator)
		{
			__proxyPtr.proxy.ProxyDispose(__proxyPtr.GetPtr(__allocator).ptr, allocator);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void ProxyDispose(this ref ProxyEvent<IInterfaceProxyTypeProxy> __proxyEvent, SafePtr<Sapientia.MemoryAllocator.Allocator> allocator)
		{
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void ProxyDispose(this ref ProxyEvent<IInterfaceProxyTypeProxy> __proxyEvent, SafePtr<Sapientia.MemoryAllocator.Allocator> __allocator, SafePtr<Sapientia.MemoryAllocator.Allocator> allocator)
		{

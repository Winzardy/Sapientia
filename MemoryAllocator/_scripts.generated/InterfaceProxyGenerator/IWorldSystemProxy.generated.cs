...
namespace Sapientia.TypeIndexer
{
	public unsafe struct IWorldSystemProxy : IProxy
	{
		...
		public delegate void PausedLateUpdateDelegate(void* __executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self);
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public readonly void PausedLateUpdate(void* __executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			var __delegate = IndexedTypes.GetDelegate(this._firstDelegateIndex + 6);
			var __method = UnsafeExt.As<Delegate, PausedLateUpdateDelegate>(__delegate);
			__method.Invoke(__executorPtr, worldState, self);
		}
		...
		{
			var __delegate = IndexedTypes.GetDelegate(this._firstDelegateIndex + 13);
			var __method = UnsafeExt.As<Delegate, StartDelegate>(__delegate);
			__method.Invoke(__executorPtr, worldState, self);
		}

		public delegate void BeforeDisposeDelegate(void* __executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self);
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		...
		{
			var __delegate = IndexedTypes.GetDelegate(this._firstDelegateIndex + 14);
		...
		{
			var __delegate = IndexedTypes.GetDelegate(this._firstDelegateIndex + 15);
	...
	public static unsafe class IWorldSystemProxyExt
	{
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void PausedLateUpdate(this in UnsafeProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.PausedLateUpdate(__proxyPtr.GetPtr().ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void PausedLateUpdate(this ref ProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.PausedLateUpdate(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void PausedLateUpdate(this ref ProxyEvent<IWorldSystemProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.PausedLateUpdate(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this in UnsafeProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> roots)
		{
			__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr().ptr, world, ref roots);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this ref ProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> roots)
		{
			__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr(__worldState).ptr, world, ref roots);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this ref ProxyEvent<IWorldSystemProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> roots)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr(__worldState).ptr, world, ref roots);
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void InnerCopy(this in UnsafeProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState oldWorld, Sapientia.MemoryAllocator.WorldState newWorld, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
			__proxyPtr.proxy.InnerCopy(__proxyPtr.GetPtr().ptr, oldWorld, newWorld, in map);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void InnerCopy(this ref ProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState oldWorld, Sapientia.MemoryAllocator.WorldState newWorld, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
			__proxyPtr.proxy.InnerCopy(__proxyPtr.GetPtr(__worldState).ptr, oldWorld, newWorld, in map);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void InnerCopy(this ref ProxyEvent<IWorldSystemProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState oldWorld, Sapientia.MemoryAllocator.WorldState newWorld, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.InnerCopy(__proxyPtr.GetPtr(__worldState).ptr, oldWorld, newWorld, in map);
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void EarlyStart(this in UnsafeProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.EarlyStart(__proxyPtr.GetPtr().ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void EarlyStart(this ref ProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.EarlyStart(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void EarlyStart(this ref ProxyEvent<IWorldSystemProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.EarlyStart(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this in UnsafeProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr().ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this ref ProxyPtr<IWorldSystemProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this ref ProxyEvent<IWorldSystemProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
	...
	public unsafe struct IWorldSystemProxy<TSource> where TSource: struct, Sapientia.MemoryAllocator.IWorldSystem
	{
		...
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldSystemProxyExt` найдите `usages` методов `PausedLateUpdate`
		private static void PausedLateUpdate(void* executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			ref var __source = ref Sapientia.Extensions.UnsafeExt.AsRef<TSource>(executorPtr);
#if PROXY_REFACTORING
#else
			__source.PausedLateUpdate(worldState, self);
#endif
		}
...
#endif
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static Delegate CreatePausedLateUpdateDelegate()
		{
			return new IWorldSystemProxy.PausedLateUpdateDelegate(PausedLateUpdate);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldSystemProxyExt` найдите `usages` методов `AppendEntities`
		...
		{
			return new IWorldSystemProxy.AppendEntitiesDelegate(AppendEntities);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldSystemProxyExt` найдите `usages` методов `InnerCopy`
		...
		{
			return new IWorldSystemProxy.InnerCopyDelegate(InnerCopy);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif
		...
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldSystemProxyExt` найдите `usages` методов `EarlyStart`
		...
		{
			return new IWorldSystemProxy.EarlyStartDelegate(EarlyStart);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif
		...
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldSystemProxyExt` найдите `usages` методов `BeforeDispose`
		private static void BeforeDispose(void* executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			ref var __source = ref Sapientia.Extensions.UnsafeExt.AsRef<TSource>(executorPtr);
#if PROXY_REFACTORING
#else
			__source.BeforeDispose(worldState, self);
#endif
		}
		...
		{
			return new IWorldSystemProxy.BeforeDisposeDelegate(BeforeDispose);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif

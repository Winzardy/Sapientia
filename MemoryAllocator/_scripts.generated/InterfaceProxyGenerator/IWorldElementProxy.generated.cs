...
namespace Sapientia.TypeIndexer
{
	...
	public static unsafe class IWorldElementProxyExt
	{
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this in UnsafeProxyPtr<IWorldElementProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr().ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this ref ProxyPtr<IWorldElementProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void BeforeDispose(this ref ProxyEvent<IWorldElementProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.IndexedPtr self)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.BeforeDispose(__proxyPtr.GetPtr(__worldState).ptr, worldState, self);
	...
	public unsafe struct IWorldElementProxy<TSource> where TSource: struct, Sapientia.MemoryAllocator.IWorldElement
	{
		...
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IWorldElementProxyExt` найдите `usages` методов `BeforeDispose`
		...
		{
			return new IWorldElementProxy.BeforeDisposeDelegate(BeforeDispose);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif

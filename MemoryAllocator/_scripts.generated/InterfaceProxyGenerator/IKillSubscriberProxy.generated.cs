...
namespace Sapientia.TypeIndexer
{
	public unsafe struct IKillSubscriberProxy : IProxy
	{
		...
		public delegate void OnEntityKilledDelegate(void* __executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver);
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public readonly void OnEntityKilled(void* __executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver)
		{
	...
	{
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void OnEntityKilled(this in UnsafeProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver)
		{
			__proxyPtr.proxy.OnEntityKilled(__proxyPtr.GetPtr().ptr, worldState, callbackReceiver);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void OnEntityKilled(this ref ProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver)
		{
			__proxyPtr.proxy.OnEntityKilled(__proxyPtr.GetPtr(__worldState).ptr, worldState, callbackReceiver);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void OnEntityKilled(this ref ProxyEvent<IKillSubscriberProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver)
		{
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static Sapientia.MemoryAllocator.IndexedPtr Copy(this in UnsafeProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState oldWS, Sapientia.MemoryAllocator.WorldState newWS, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
			return __proxyPtr.proxy.Copy(__proxyPtr.GetPtr().ptr, oldWS, newWS, in map);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static Sapientia.MemoryAllocator.IndexedPtr Copy(this ref ProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState oldWS, Sapientia.MemoryAllocator.WorldState newWS, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
			return __proxyPtr.proxy.Copy(__proxyPtr.GetPtr(__worldState).ptr, oldWS, newWS, in map);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static Sapientia.MemoryAllocator.IndexedPtr Copy(this ref ProxyEvent<IKillSubscriberProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState oldWS, Sapientia.MemoryAllocator.WorldState newWS, in Sapientia.MemoryAllocator.State.EntityCopyMap map)
		{
		...
		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this in UnsafeProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> entities)
		{
			__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr().ptr, world, ref entities);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this ref ProxyPtr<IKillSubscriberProxy> __proxyPtr, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> entities)
		{
			__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr(__worldState).ptr, world, ref entities);
		}

		[System.Runtime.CompilerServices.MethodImplAttribute(256)]
		public static void AppendEntities(this ref ProxyEvent<IKillSubscriberProxy> __proxyEvent, Sapientia.MemoryAllocator.WorldState __worldState, Sapientia.MemoryAllocator.WorldState world, ref Sapientia.Collections.UnsafeList<Sapientia.MemoryAllocator.State.Entity> entities)
		{
			foreach (ref var __proxyPtr in __proxyEvent.GetEnumerable(__worldState))
			{
				__proxyPtr.proxy.AppendEntities(__proxyPtr.GetPtr(__worldState).ptr, world, ref entities);
	...
	public unsafe struct IKillSubscriberProxy<TSource> where TSource: struct, Sapientia.MemoryAllocator.State.IKillSubscriber
	{
		...
		private static void OnEntityKilled(void* executorPtr, Sapientia.MemoryAllocator.WorldState worldState, Sapientia.MemoryAllocator.State.Entity callbackReceiver)
		{
			ref var __source = ref Sapientia.Extensions.UnsafeExt.AsRef<TSource>(executorPtr);
#if PROXY_REFACTORING
#else
			__source.OnEntityKilled(worldState, callbackReceiver);
#endif
		}
		...
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IKillSubscriberProxyExt` найдите `usages` методов `Copy`
...
return default;
		...
		{
			return new IKillSubscriberProxy.CopyDelegate(Copy);
		}
#if UNITY_5_3_OR_NEWER
		[UnityEngine.Scripting.Preserve]
#endif
		// Чтобы найти дальнейшие `usages` метода - выше в классе `IKillSubscriberProxyExt` найдите `usages` методов `AppendEntities`
		...
		{
			return new IKillSubscriberProxy.AppendEntitiesDelegate(AppendEntities);
		}
	}
}

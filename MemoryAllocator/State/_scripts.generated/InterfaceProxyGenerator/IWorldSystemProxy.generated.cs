...
namespace Sapientia.TypeIndexer
{
	...
	{
		public static readonly ProxyIndex ProxyIndex = 31;
	...
	public static unsafe class IWorldSystemProxyExt
	{
		...
		{
			__proxyPtr.proxy.Update(__proxyPtr.GetPtr(), allocator, self, deltaTime);
		}
		...
		{
			__proxyPtr.proxy.Update(__proxyPtr.GetPtr(__allocator), allocator, self, deltaTime);
		}
		...
		{
			__proxyPtr.proxy.LateUpdate(__proxyPtr.GetPtr(), allocator, self);
		}
		...
		{
			__proxyPtr.proxy.LateUpdate(__proxyPtr.GetPtr(__allocator), allocator, self);
		}

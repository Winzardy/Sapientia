...
namespace Sapientia.Utility
{
	...
	public static class ReflectionCacheExtensions
	{
		...
		public static bool TryCreateInstance<T>(this IReflectionCache cache, Type type, out T instance) where T : new()
		{
			instance = cache.CreateInstance<T>(type);
			return instance != null;
		}

		public static bool TryCreateInstance(this IReflectionCache cache, Type type, out object instance)
		{
		...
		public static bool TryGetAllDerivedTypes<T>(this IReflectionCache cache, out List<Type> types, Func<Type, bool> predicate = null)
		{
			return cache.TryGetAllDerivedTypes(typeof(T), out types, predicate);
		}

		public static bool TryGetAllDerivedTypes(this IReflectionCache cache, Type baseType, out List<Type> types, Func<Type, bool> predicate = null)
		{
